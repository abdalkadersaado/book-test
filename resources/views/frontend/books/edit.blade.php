...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit book ({{ $book->title }})</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('users.books_update_edit', $book->id) }}" method="POST">
        @csrf
        @method('POST')
            <div class="row">
                    <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control summernote" >{!! old('description',$book->description)  !!}</textarea>
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <select name="genres[]" multiple class="form-control selects" id="select_all_genres">
                            ...
                            <option value="{{ $genre->id }}" {{ in_array($genre->id, old('genres[]',$book->genres->pluck('id')->toArray())) ? 'selected': '' }}>{{ $genre->title }}</option>
                            @endforeach
                        </select>
