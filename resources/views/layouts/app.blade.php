...
<body style="background-color: #ce7852">
    <div id="app">
...
$(document).on('click','#saveLikeDislike',function(){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data.count_like != null){
                var _count_like = data.count_like;
                console.log(_count_like);
                //  var _prevCount=$("."+_type+"-count").text(_count_like);
                 var html = '';
            ...
            if(data.count_dislike != null){
                var _count_dislike = data.count_dislike;
                console.log(_count_dislike);
                //  var _prevCount=$(".dislike-count").text(_count_dislike);
                var html = '';
                 html +=  _count_dislike
            $('.disliked-count').text(html);
            }
        }
    });
});
